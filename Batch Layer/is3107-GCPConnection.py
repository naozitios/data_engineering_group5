...
with DAG(
    ...
    def get_delay_data(**kwargs):
        url ='https://airlabs.co/api/v9/delays?delay=30&type=departures&api_key=d5619290-fdac-445d-98ee-42f9c32127db'
    ...
    def get_weather_data(**kwargs):
        ...
        data = []
        api_key = '99320ef2686ced830168a02c83901c32'
        ...
        #save as csv into own directory
